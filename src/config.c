...
load_general(void)
{
    ...
    vid_mister_delta = !!ini_section_get_int(cat, "vid_mister_delta", 0);   
...
save_general(void)
{
    ...
    if (vid_mister_delta == 0)
        ini_section_delete_var(cat, "vid_mister_delta");
    else
        ini_section_set_int(cat, "vid_mister_delta", vid_mister_delta);
